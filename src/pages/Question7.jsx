...
function Question7() {
    ...
    navigate('/Question7'); // Navigate to the seventh question
    ...
    useEffect(() => {
        ...
        if (savedAnswers[6]) setSelectedAnswer(savedAnswers[6]); 
    }, []);
    ...
    const handleSelect = (id) => {
        ...
        savedAnswers[6] = id; // Store answer at index 0 (Question 1)
